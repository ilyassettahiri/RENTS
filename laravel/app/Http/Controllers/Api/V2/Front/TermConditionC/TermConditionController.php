...
namespace App\Http\Controllers\Api\V2\Front\TermConditionC;
...
class TermConditionController extends JsonApiController
{
        ...
        $policypage = Policypage::find(1);
                    ...
                    $policypageData = [
                        ...
                        'attributes' => [
                            ...
                            'content' => $policypage->termcondition,
                            'privacy' => $policypage->privacy,
                            'updated_at' => $policypage->updated_at,
