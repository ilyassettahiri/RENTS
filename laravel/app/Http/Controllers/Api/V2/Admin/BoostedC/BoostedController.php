...
namespace App\Http\Controllers\Api\V2\Admin\BoostedC;
...
class BoostedController extends JsonApiController
{
    ...
    {
        $user = Auth::user();
        $listings = Listing::where('user_id', $user->id)->where('status', 'boosted')->get();
