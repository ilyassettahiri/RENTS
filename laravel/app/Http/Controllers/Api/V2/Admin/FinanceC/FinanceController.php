...
namespace App\Http\Controllers\Api\V2\Admin\FinanceC;
...
class FinanceController extends JsonApiController
{
    ...
    {
        $user = Auth::user();
        $listings = Listing::where('user_id', $user->id)->take(5)->get();
