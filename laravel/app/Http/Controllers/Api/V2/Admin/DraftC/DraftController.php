...
namespace App\Http\Controllers\Api\V2\Admin\DraftC;
...
class DraftController extends JsonApiController
{
    ...
    {
        $user = Auth::user();
        $listings = Listing::where('user_id', $user->id)->where('status', 'draft')->get();
