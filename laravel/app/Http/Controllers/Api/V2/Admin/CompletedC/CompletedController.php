...
namespace App\Http\Controllers\Api\V2\Admin\CompletedC;
...
class CompletedController extends JsonApiController
{
    ...
    {
        $user = Auth::user();
        $listings = Listing::where('user_id', $user->id)->where('status', 'completed')->get();
