...
namespace App\JsonApi\V2\Sonorisationsimg;

use App\Models\Sonorisationimg;
use Carbon\Carbon;
...
class SonorisationimgSchema extends Schema
{



    public static string $model = Sonorisationimg::class;
