...
namespace App\JsonApi\V2\Taxiaeroportsimg;

use App\Models\Taxiaeroportimg;
use Carbon\Carbon;
...
class TaxiaeroportimgSchema extends Schema
{



    public static string $model = Taxiaeroportimg::class;
