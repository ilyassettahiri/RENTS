...
namespace App\JsonApi\V2\Photographiesimg;

use App\Models\Photographieimg;
use Carbon\Carbon;
...
class PhotographieimgSchema extends Schema
{



    public static string $model = Photographieimg::class;
