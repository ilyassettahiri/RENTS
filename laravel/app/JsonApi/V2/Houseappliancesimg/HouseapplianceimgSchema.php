...
namespace App\JsonApi\V2\Houseappliancesimg;

use App\Models\Houseapplianceimg;
use Carbon\Carbon;
...
class HouseapplianceimgSchema extends Schema
{



    public static string $model = Houseapplianceimg::class;
