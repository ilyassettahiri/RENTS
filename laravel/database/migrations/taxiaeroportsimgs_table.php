...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('taxiaeroportsimgs', function (Blueprint $table) {
            $table->id();


            $table->foreignId('taxiaeroport_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('taxiaeroportsimgs');
    }
};
