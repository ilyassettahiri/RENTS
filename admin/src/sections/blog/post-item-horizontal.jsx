      ...
      <Card sx={{ display: 'flex' }}>
        ...
        >
          <Avatar
            ...
            src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}${author.picture}`}
            sx={{ top: 16, right: 16, zIndex: 9, position: 'absolute' }}
          />
          <Image alt={title} src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}${thumb}`} sx={{ height: 1, borderRadius: 1.5 }} />
        </Box>
      </Card>
