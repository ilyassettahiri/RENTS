...
import { CustomerDetailsView } from 'src/sections/customer/view';

// ----------------------------------------------------------------------

export const metadata = { title: `Customer details | Dashboard - ${CONFIG.site.name}` };
...
export default async function Page({ params }) {
  ...
  return <CustomerDetailsView customer={customer} />;
}
