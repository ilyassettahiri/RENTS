  ...
  (
    ...
    const content = (
      <Box
        ...
        placeholderSrc={disabledEffect ? `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/transparent.png` : `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/placeholder.svg`}
        //
        sx={{
          width: 1,
          height: 1,
