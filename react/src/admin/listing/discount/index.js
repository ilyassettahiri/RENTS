...
function ListDiscount() {
  ...
  const handleEditRow = useCallback((id) => navigate(`/discount/detail-discount/${id}`), [navigate]);


  const handleViewRow = useCallback((id) => navigate(`/discount/detail-discount/${id}`), [navigate]);
