...
const icon1 = `${imagePath}/categoryicons/tablettes/camera_specifications.svg`;
const icon2 = `${imagePath}/categoryicons/tablettes/condition.svg`;
const icon3 = `${imagePath}/categoryicons/tablettes/connectivity.svg`;
const icon4 = `${imagePath}/categoryicons/tablettes/display_size.svg`;
const icon5 = `${imagePath}/categoryicons/tablettes/operating_system.svg`;
const icon6 = `${imagePath}/categoryicons/tablettes/pressure_sensitivity.svg`;
const icon7 = `${imagePath}/categoryicons/tablettes/ram.svg`;
const icon8 = `${imagePath}/categoryicons/tablettes/storage.svg`;
const icon9 = `${imagePath}/categoryicons/tablettes/display_resolution.svg`;
