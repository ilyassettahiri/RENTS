...
const icon1 = `${imagePath}/categoryicons/immobilier/villa/rooms.svg`;
const icon2 = `${imagePath}/categoryicons/immobilier/villa/living_room.svg`;
const icon3 = `${imagePath}/categoryicons/immobilier/villa/bedrooms.svg`;
const icon4 = `${imagePath}/categoryicons/immobilier/villa/bathrooms.svg`;
const icon5 = `${imagePath}/categoryicons/immobilier/villa/view.svg`;
const icon6 = `${imagePath}/categoryicons/immobilier/villa/security_system.svg`;
const icon7 = `${imagePath}/categoryicons/immobilier/villa/facilities.svg`;
const icon8 = `${imagePath}/categoryicons/immobilier/villa/amenities.svg`;
const icon9 = `${imagePath}/categoryicons/immobilier/villa/service.svg`;
