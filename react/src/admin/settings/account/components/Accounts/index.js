...
const logoSlack = `${imagePath}/small-logos/logo-slack.svg`;
const logoAtlassian = `${imagePath}/small-logos/logo-atlassian.svg`;
const logoAsana = `${imagePath}/small-logos/logo-asana.svg`;
