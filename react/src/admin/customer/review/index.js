...
function ListReview() {
  ...
  const handleEditRow = useCallback((id) => navigate(`/review/edit-review/${id}`), [navigate]);


  const handleViewRow = useCallback((id) => navigate(`/review/detail-review/${id}`), [navigate]);
