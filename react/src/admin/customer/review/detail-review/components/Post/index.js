...
const team1 = 'curved-images/curved2.jpg';

const bruceMars = `${imagePath}/curved-images/curved0.jpg`;

const workSpace = `${imagePath}/curved-images/curved1.jpg`;
  ...
  return (
    <Card>
      <SoftBox
        ...
        px={3}
      >
        <SoftAvatar src={team1} alt="profile-image" variant="rounded" />
        ...
        <SoftBox mt={3} mb={1} px={1}>
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item xs={12} sm={6}>
              <SoftBox
                ...
                width="100%"
              >
                <SoftAvatar src={team1} alt="person 1" size="xs" />
                <SoftAvatar src={team1} alt="person 2" size="xs" />
          ...
          <SoftBox display="flex" alignItems="center" mt={3}>
            <SoftBox flexShrink={0} mr={2}>
              <SoftAvatar src={team1} alt="profile picture" />
            </SoftBox>
            <SoftBox flexGrow={1}>
