...
function ListCustomer() {
  ...
  const handleEditRow = useCallback((id) => navigate(`/customer/edit-customer/${id}`), [navigate]);


  const handleViewRow = useCallback((id) => navigate(`/customer/detail-customer/${id}`), [navigate]);
