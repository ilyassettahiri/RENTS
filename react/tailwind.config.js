...
theme: {
  ...
  backgroundImage: ({ theme }) => ({
    ...
    "gradient-fuchsia": "linear-gradient(310deg," + theme("colors.blue.600") + "," + theme("colors.cyan.400") + ")",
  ...
  boxShadow: {
    ...
    "soft-xs": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1),0 2px 3px -1px rgba(0,0,0,.07)",
    "soft-sm": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1),0 .125rem .25rem -.0625rem hsla(0,0%,8%,.07)",
    "soft-md": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1),0 2px 4px -1px rgba(0,0,0,.07)",
    "soft-lg": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1)",
    "soft-xl": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1) ",
    "soft-2xl": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1)",
    "soft-3xl": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1),0 8px 9px -5px hsla(0,0%,8%,.06)",
    ...
    sm: "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1)",
    md: "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)",
    lg: "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)",
    xl: "0 23px 45px -11px hsla(0,0%,8%,.25)",
    "2xl": "0rem 0.25rem 0.375rem -0.0625rem rgba(0, 0, 0, 0.1)",
    none: "none",
  },
