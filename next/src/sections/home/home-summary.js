...
const SUMMARY = [
  {
    ...
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/travel/ic_travel_tickets.svg`,
  },
  {
    total: 196,
    description: 'Tours booked',
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/travel/ic_travel_booking.svg`,
  },
  {
    total: 10670,
    description: 'Site visitors',
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/travel/ic_travel_site_visitors.svg`,
  },
  {
    total: 877,
    description: 'Verified hotels',
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/travel/ic_travel_verified_hotels.svg`,
  },
];
