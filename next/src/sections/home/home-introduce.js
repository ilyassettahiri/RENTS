...
const SUMMARY = [
  {
    ...
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/ic_popularity.svg`,
  },
  {
    title: 'Customer Satisfaction',
    description: 'Nunc nonummy metus. Donec elit libero',
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/ic_reputation.svg`,
  },
  {
    title: 'Secure Payment',
    description: 'Nunc nonummy metus. Donec elit libero',
    icon: `${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/icons/ic_secure_payment.svg`,
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <Image
          alt="cover"
          src={`${process.env.NEXT_PUBLIC_STATIC_IMAGE_BASE_URL}/assets/images/travel/travel_post_hero.jpg`}
          width={1600}
